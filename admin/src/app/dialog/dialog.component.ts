...
export class DialogComponent implements OnInit
{
  ...
  ngOnInit(): void {
    ...
    if(this.editData){
      ...
      this.protectForm.controls['countInStock'].setValue(this.editData.countInStock);
      ...
      this.protectForm.controls['numReviews'].setValue(this.editData.numReviews);
      this.protectForm.controls['description'].setValue(this.editData.description);
  ...
  addProduct() {
    ...
    if(!this.editData){
      if (this.protectForm.valid ) {
        this.api.postProduct(this.protectForm.value,).subscribe({
          next: (res) => {
  ...
  updateProduct(){
    ...
    console.log(this.protectForm.value)
        this.api.putProduct(this.protectForm.value,this.editData._id).subscribe({
          ...
          error: () => {
            alert('Error Product not update');
          },
        });
  }
}
