...
function PlaceOrder() {
    ...
    cart.shippingPrice = cart.itemsPrice > 5000 ? round2(0) : round2(10);
                                    ...
                                    <ListGroup.Item key={item._id}>
                                        <Row className='align-items-center'>
                                            <Col md={6}>
                                                ...
                                                <Link to={`/api/products/slug/${item.slug}`}  >{item.name}</Link>
                                            </Col>
                                            <Col md={3}>
                                                <span></span>
                                                {item.quantity}</Col>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <ListGroup variant='flush'>
                                ...
                                <ListGroup.Item>
                                    <Row>
                                        <Col><strong>Order Tota</strong></Col>
                                        <Col>
                                ...
                                <ListGroup.Item>
                                    ...
                                    <div className='m-3 d-grid'>{loading && <LoadingBox></LoadingBox>}</div>
